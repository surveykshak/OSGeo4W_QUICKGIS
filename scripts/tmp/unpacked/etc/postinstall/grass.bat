...
if not %OSGEO4W_MENU_LINKS%==0 xxmklink "%OSGEO4W_STARTMENU%\GRASS GIS 8.4.2.lnk" "%BATCH%"  "--gui" "%DOCUMENTS%" "Launch GRASS GIS 8.4.2" 1 "%ICON%"
if not %OSGEO4W_DESKTOP_LINKS%==0 xxmklink "%OSGEO4W_DESKTOP%\GRASS GIS 8.4.2.lnk" "%BATCH%"  "--gui" "%DOCUMENTS%" "Launch GRASS GIS 8.4.2" 1 "%ICON%"
